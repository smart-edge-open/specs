...
- [Running playbooks](#running-playbooks)
  ...
  - [Network Edge](#network-edge)
    - [Kubernetes Topology Manager and CPU Management](#kubernetes-topology-manager-and-cpu-management)
    - [SRIOV](#sriov)
- [Q&A](#qa)
...
- Hosts for Kubernetes master and workers (Edge Nodes) must have proper and unique hostname (not `localhost`). That hostname must be in `/etc/hosts` as well. (refer to [Setup static hostname](#Setup-static-hostname))
